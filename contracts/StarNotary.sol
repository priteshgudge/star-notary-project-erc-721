...
contract StarNotary is ERC721,ERC721Metadata {
    ...
    // symbol: Is a short string like 'USD' -> 'American Dollar'
     constructor() ERC721Metadata("PriteshToken", "PTC") public {}

    // Custom Name Each Time
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        // Star memory token1Star = tokenIdToStartInfo[_tokenId1];
        // Star memory token2Star = tokenIdToStartInfo[_tokenId2];
